...
<head>
    ...
    <title>About PathPilot | Our Mission</title>
...
<section class="relative bg-gradient-to-br from-indigo-700 via-primary to-purple-800 text-white py-32 px-6 overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto text-center relative z-10">
        ...
        <h1 class="text-5xl md:text-7xl font-800 mt-10 leading-[1.1] tracking-tight">
            From Student <span class="text-yellow-300">Confusion</span><br>
            To Industry <span class="text-white underline decoration-yellow-400 decoration-4 underline-offset-8">Career</span>
        </h1>
...
<section class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 py-24 px-6">
    <div class="bg-white p-10 rounded-3xl shadow-sm text-center border border-gray-100 hover:border-primary/20 transition-all group">
...
<section class="bg-gray-900 text-white py-28 text-center relative overflow-hidden">
    ...
    <div class="flex justify-center gap-6 flex-wrap">
        ...
        <a href="<%=request.getContextPath()%>/guest/contact"
